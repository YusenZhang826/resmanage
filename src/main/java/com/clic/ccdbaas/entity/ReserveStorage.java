...
@TableName(value = "t_reserve_storage")
@Data
public class ReserveStorage extends BaseEntity {
    @ExcelProperty("设备名称")
    @Excel(name = "设备名称")
    private String name;
    ...
    @ExcelProperty("总可用容量(TB)")
    @Excel(name = "总可用容量(TB)")
    private Integer totalStorageCapacity;

    @ExcelProperty("剩余容量(TB)")
    @Excel(name = "剩余容量(TB)")
    private Integer restStorageCapacity;
    ...
    public void setServerArchitecture(String serverArchitecture) {
        this.serverArchitecture = serverArchitecture == null ? null : serverArchitecture.trim();
    }
    ...
    public Integer getRestStorageCapacity() {
        return restStorageCapacity;
    }

    public void setRestStorageCapacity(Integer restStorageCapacity) {
        this.restStorageCapacity = restStorageCapacity;
    }
    ...
    public String toString() {
        ...
        sb.append(", serverArchitecture=").append(serverArchitecture);
        sb.append(", type1=").append(type1);
        sb.append(", type2=").append(type2);
        sb.append(", warrantyContract=").append(warrantyContract);
        sb.append(", totalStorageCapacity=").append(totalStorageCapacity);
        sb.append(", restStorageCapacity=").append(restStorageCapacity);
