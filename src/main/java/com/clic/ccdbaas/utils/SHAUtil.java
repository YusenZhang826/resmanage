...
public class SHAUtil {
    ...
    public static String getSHA1(String painText) {
        return getSha(painText, SHA_1);
    }

    public static String getSHA224(String painText) {
        return getSha(painText, SHA_224);
    }

    public static String getSHA256(String painText) {
        return getSha(painText, SHA_256);
    }

    public static String getSHA384(String painText) {
        return getSha(painText, SHA_384);
    }

    public static String getSHA512(String painText) {
        return getSha(painText, SHA_512);
    }
